...
wda.Set_External_Potential(extpotmodel='steele',params=[sigmaw, epsw, Delta])
...
mmfa.Set_External_Potential(extpotmodel='steele',params=[sigmaw, epsw, Delta])
...
xMC,rhoMC = MCdata[:,0], MCdata[:,1]
plt.scatter(xMC,rhoMC,marker='^',edgecolors='C1',facecolors='none',label=r'$H/\sigma =$'+str(L))
...
xMC,rhoMC = MCdata[:,0], MCdata[:,1]
plt.scatter(xMC-0.5,rhoMC,marker='s',edgecolors='C3',facecolors='none',label=r'$H/\sigma =$'+str(L))
