...
N = 256
rhob = 0.2
n1 = np.load('../fmt-wbi-densityfield-rhob0.2-N256-delta0.05.npy')
r1 = np.arange(N//2) * 0.05
ax[0,0].plot(r1,n1[N//2:,N//2,N//2]/rhob,':',color='k',alpha=0.5,label='$\Delta=0.05$')
...
N = 256
n1 = np.load('../fmt-wbi-densityfield-rhob0.5-N256-delta0.05.npy')
r1 = np.arange(N//2) * 0.05
ax[0,1].plot(r1,n1[N//2:,N//2,N//2],':',color='grey')
...
n1 = np.load('../fmt-wbi-densityfield-rhob0.5-N256-delta0.05.npy')
r1 = np.arange(N//2) * 0.05
ax[0,2].plot(r1,n1[N//2:,N//2,N//2],':',color='grey')
...
n1 = np.load('../fmt-wbi-densityfield-rhob0.5-N256-delta0.05.npy')
r1 = np.arange(N//2) * 0.05
ax[0,3].plot(r1,n1[N//2:,N//2,N//2],':',color='grey')
...
rhob = 0.6
n1 = np.load('../fmt-wbi-densityfield-rhob0.6-N256-delta0.03.npy')
r1 = np.arange(N//2) * 0.03
...
rhob = 0.7
n1 = np.load('../fmt-wbi-densityfield-rhob0.7-N256-delta0.03.npy')
r1 = np.arange(N//2) * 0.03
...
N = 256
rhob = 0.8
n1 = np.load('../fmt-wbi-densityfield-rhob0.8-N256-delta0.03.npy')
r1 = np.arange(N//2) * 0.03
...
N = 256
rhob = 0.9
n1 = np.load('../fmt-wbi-densityfield-rhob0.9-N256-delta0.05.npy')
r1 = np.arange(N//2) * 0.05
ax[1,3].plot(r1,n1[N//2:,N//2,N//2]/rhob,':',color='k',alpha=0.5,label='$\Delta=0.05$')

n1 = np.load('../fmt-wbi-densityfield-rhob0.9-N256-delta0.03.npy')
r1 = np.arange(N//2) * 0.03
ax[1,3].plot(r1,n1[N//2:,N//2,N//2]/rhob,'-',color='k',label='$\Delta=0.03$')
