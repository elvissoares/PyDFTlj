...
def phi3funcWBI(eta):
    if eta<=1e-3:
        return 36*pi*(1.5+8*eta/3+15*eta**2/4)
    else: 
...
def dphi3dnfuncWBI(eta):
    if eta<=1e-3:
        return 36*pi*(8/3+7.5*eta+72*eta**2/5)
    else: 
...
def phi3funcWBII(eta):
    if eta<=1e-3:
        return 36*pi*(1.5+7*eta/3+13*eta**2/4)
    else: 
...
def dphi3dnfuncWBII(eta):
    if eta<=1e-3:
        return 36*pi*(7/3+6.5*eta+63*eta**2/5)
    else: 
